      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">No necesitas ser un experto para ser un as en las finanzas</h2>
            <p className="text-xl text-gray-400">Tan solo tienes que apoquinar la cantidad indicda, pero nosotros te recomendamos la PRO por que si no vamos a pensar que eres un tieso.</p>
          </div>
